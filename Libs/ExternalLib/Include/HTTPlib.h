...
#define DBG_HTTP_SEND
#define DBG_HTTP_READ
...
//int HTTP_Delete(TCP_SOCKET socket, char * host, char * path, char * custom_header, char * CType, char * data, char * header, int headersize, char * body, int bodysize, int timeout);
